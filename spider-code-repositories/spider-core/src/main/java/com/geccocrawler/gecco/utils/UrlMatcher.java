...
public class UrlMatcher {
	...
	public static void main(String[] args) {
        ...
        String urlA1 = "https://gitlab.xxxxx.com/qqq/qqq/qqq";
        String urlA2 = "https://gitlab.xxxxx.com/qqq";
        String urlA3 = "https://gitlab.xxxxx.com/";
        String urlA4 = "https://gitlab.xxxxx.com/aa?a=123&b=456";
		String regexA = "https://gitlab.xxxxx.com{path:[^\\?]*}{wenhao:[\\?]?}{param:.*}";
		System.out.println(match(urlA1, regexA));
