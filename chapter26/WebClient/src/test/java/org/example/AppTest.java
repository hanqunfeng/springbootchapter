...
public class AppTest {
    ...
    public void getTest() {
        ...
        System.out.println("getBytes=" + new String(WebClientUtil.getBytes(URL_GET_BYTES, map), StandardCharsets.UTF_8));
        System.out.println("getBytesZip=" + new String(WebClientUtil.getBytes(URL_GET_BYTES_ZIP, map), StandardCharsets.UTF_8));
    }
    ...
    public void postTest() {
        ...
        System.out.println("postParamGetBytes=" + new String(WebClientUtil.postBytes(URL_GET_BYTES, map), StandardCharsets.UTF_8));
        System.out.println("postParamGetBytesZip=" + new String(WebClientUtil.postBytes(URL_GET_BYTES_ZIP, map), StandardCharsets.UTF_8));
    }
}
