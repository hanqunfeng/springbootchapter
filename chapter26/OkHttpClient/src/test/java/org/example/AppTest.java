...
public class AppTest {
    ...
    public void getTest() {
        ...
        System.out.println("getBytes=" + new String(OkHttpUtil.getBytes(URL_GET_BYTES, map), StandardCharsets.UTF_8));
        System.out.println("getBytesZip=" + new String(OkHttpUtil.getBytes(URL_GET_BYTES_ZIP, map), StandardCharsets.UTF_8));
    }
