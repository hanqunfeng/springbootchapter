package com.example.swagger3mvndemo.config;
...
public class Swagger3Config {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.OAS_30)
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.swagger3mvndemo"))
    ...
    public Docket createRestApiForDemo() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.example.swagger3mvndemo.controller")) //基于扫描路径
    ...
    public Docket createRestApiForSecurity() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.example.swagger3mvndemo.securityController")) //基于扫描路径
                //.apis(RequestHandlerSelectors.any()) //基于url
                .paths(PathSelectors.any()) //任意的url
