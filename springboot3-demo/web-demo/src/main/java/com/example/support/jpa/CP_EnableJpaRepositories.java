...
/**
 * <h1>重写EnableJpaRepositories</h1>
 * 就是复制的EnableJpaRepositories源代码，只不过@Import(CP_JpaRepositoriesRegistrar.class)
 * 其目的就是为了实现basePackages属性基于配置文件的数组形式
 */
...
@Documented
@Inherited
@Import(CP_JpaRepositoriesRegistrar.class)
public @interface CP_EnableJpaRepositories {
