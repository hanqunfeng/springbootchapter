...
/**
 * <h1></h1>
 * Created by hanqf on 2023/8/15 11:09.
 */
...
public interface AnnotationsBookMapper
{
    ...
    @Results({
            ...
            @Result(column="userId",property="user",one=@One(select="com.example.dao.AnnotationsUserMapper.selectByPrimaryKey",fetchType= FetchType.EAGER))
    })
