...
public class WorkQueuesConsumer {
    ...
    @RabbitListener(queues = {RabbitMQConstants.QUEUE_NAME_WORK_QUEUES}, messageConverter = "jsonConverter")
    public void receive01(Map<String, Object> message) {
        System.out.println("consumer received01 message map: " + message);
    }

    @RabbitListener(queues = {RabbitMQConstants.QUEUE_NAME_WORK_QUEUES}, ackMode = "MANUAL")
    ...
    @RabbitListener(queues = {RabbitMQConstants.QUEUE_NAME_WORK_QUEUES})
    public void receive03(Map<String, Object> message) {
        System.out.println("consumer received03 message map: " + message);
    }
}
