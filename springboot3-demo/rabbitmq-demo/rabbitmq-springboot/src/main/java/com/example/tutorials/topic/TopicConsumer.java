...
public class TopicConsumer {
    ...
    @RabbitListener(queues = {RabbitMQConstants.QUEUE_NAME_TOPIC_1}, messageConverter = "jsonConverter")
    public void receive01(Map<String, Object> message) {
        System.out.println("consumer received01 message map: " + message);
    }

    @RabbitListener(queues = {RabbitMQConstants.QUEUE_NAME_TOPIC_2}, ackMode = "MANUAL")
