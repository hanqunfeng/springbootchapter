package com.hanqf.resumedtransferoffset.controller;

import com.amazonaws.services.s3.model.ObjectMetadata;
import com.hanqf.resumedtransferoffset.utils.AmazonS3Util;
import com.hanqf.resumedtransferoffset.utils.MyIOUtil;
...
public class DemoController {
    ...
    public void s3Down(@PathVariable int num, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        final ObjectMetadata objectMetadata = AmazonS3Util.getObjectMetadata(remoteFileName);
        final long contentLength = objectMetadata.getContentLength();
        final java.util.List<Long> positions = AmazonS3Util.positions(contentLength);
        ...
        AmazonS3Util.downloadSubsectionAndCloseOutputStream(remoteFileName, start, end, outputStream);
    ...
    */
    ...
    public void s3DownRange(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.addHeader("Content-Disposition", "attachment;filename=" + fileName);
        ServletOutputStream outputStream = response.getOutputStream();
        AmazonS3Util.downloadSubsectionAndCloseOutputStream(remoteFileName, startIndex, endIndex, outputStream);
